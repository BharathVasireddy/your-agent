    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <Button
          type="button"
          variant="outline"
          onClick={() => signIn('google', { callbackUrl: searchParams.get('callbackUrl') || '/onboarding/welcome' })}
          disabled={isLoading}
          className="w-full"
        >
        ...
        <Button
          type="button"
          variant="outline"
          onClick={() => signIn('github', { callbackUrl: searchParams.get('callbackUrl') || '/onboarding/welcome' })}
          disabled={isLoading}
          className="w-full"
        >
