...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      // Track colors and borders for states
      "border data-[state=checked]:bg-brand data-[state=unchecked]:bg-zinc-200",
      "data-[state=checked]:border-brand-soft data-[state=unchecked]:border-zinc-300",
      className,
    )}
    {...props}
    ref={ref}
