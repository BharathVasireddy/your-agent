...
export default function LegacyPropertyDetail({ agent, property, similar }: { agent: Agent; property: Property; similar: Property[]; isOwner?: boolean; }) {
  ...
  return (
    <main className="w-full">
      ...
      {/* Footer */}
      <Footer agent={agent as unknown as { websiteUrl?: string | null; officeAddress?: string | null; officeMapUrl?: string | null; facebookUrl?: string | null; instagramUrl?: string | null; linkedinUrl?: string | null; youtubeUrl?: string | null; twitterUrl?: string | null }} />
    </main>
  );
}
