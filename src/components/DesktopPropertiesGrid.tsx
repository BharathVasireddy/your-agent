...
interface Property {
  ...
  listingType: string;
  propertyType: string;
  // optional: show/hide toggle visibility for deals
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2">
          {property.sourceDealId ? (
            <span className="flex-1 inline-flex items-center justify-center px-3 py-2 bg-zinc-100 text-zinc-500 rounded-lg text-sm font-medium cursor-not-allowed">
