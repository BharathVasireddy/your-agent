...
export default function PlotForm({ 
  ...
  return (
    <BasePropertyForm
      ...
      onCancel={onCancel}
    >
      {/* Plot specific fields will be added here */}
      <div className="bg-white rounded-xl shadow-sm border border-zinc-200 p-6">
        <h3 className="text-lg font-semibold text-zinc-900 mb-4">Plot Details</h3>
        <div className="text-center py-8 text-zinc-500">
          <p>Plot specific fields will be implemented here.</p>
